...
# visual settings
color <- brewer.pal(9, "Paired")[c(1, 3)]
text_size <- 14
dot_size <- 0.5
boxplot_width <- 0.6
  ...
  ggplot(aes(x = factor(Staining, 
        ...
        theme(legend.position = 'right',
      	...
      	labs( x=element_blank(),
          		...
          		title = 'Blocking of KIR receptor removes false positive responses',
          		subtitle ='Limited availability of paired samples from flow cytometry',
          	  color = 'Sample ID',
          		caption = 'Data: S. K. Saini et. al 2021')
...
ggplot(unpaired, 
      ...
      theme(legend.position="none",
    	...
    	labs( x=element_blank(),
        		y='% multimer CD8+ T-cells',
        		title = 'KIR blocking ',
        		subtitle ='Decrease in false positive responses across cohorts',
        	  fill = 'KIR Blocking',
        		caption = 'Data: S. K. Saini et. al 2021')
