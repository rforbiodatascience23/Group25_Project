...
if (!dir.exists(data_path)) {
  stop("The data needs to be loaded first, before running these script. Go to https://dtudk-my.sharepoint.com/:f:/r/personal/s194360_dtu_dk/Documents/R%20for%20BioData?csf=1&web=1&e=FMK1xA and dowload the data folder, then upload it as is.")
}
...
outfile_name_barra <- "01_dat_load_barracoda.csv"
outfile_path_barra <- file.path(data_path, outfile_name_barra)

outfile_name_flow <- "01_dat_load_flowjo.csv"
